...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar yamm navbar-default hidden-xs hidden-xs second-navbar" role="navigation">
        <div class="container">
          <!-- Brand and toggle get grouped for better mobile display -->
          <div class="navbar-header">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-11">
            <ul class="nav navbar-nav second-navbar-nav">
              <li class="dropdown yamm-fw"> <!-- Football -->
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">Football</a>
               <ul class="dropdown-menu">
                 <li>
                     <div class="yamm-content container" style="text-align:center;">
                        <div class="row">
              ...
              <li class="dropdown yamm-fw"> <!-- Basketball -->
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">Basketball</a>
               <ul class="dropdown-menu">
                 <div class="yamm-content container" style="text-align:center;">
                    <div class="row">
                      <div class="col-sm-3 col-md-3 col-lg-3">
